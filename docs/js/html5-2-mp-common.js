...
/* Allows the user to use a static poster image for an animated gif */
function animatedGifPoster(){
    if ($(".poster img").length) {
        var posterwidth = $('.poster img').width();
        
        $('div.animated-gif').width(posterwidth);
        
        $('div.animated-gif .gif').hide();
        $('.animated-gif').on("mouseover", function () {
            $('.gif').show();
            $('.poster').hide();
        });
        
        $('.animated-gif').on("mouseout", function () {
            $('.gif').hide();
            $('.poster').show();
        });
    }
